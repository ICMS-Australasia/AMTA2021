...
<script type="text/javascript">
  const pds_speakers = [
    ...
    },
    {
      ...
      about: "It's no secret that the strength of an allied health professional’s report can make or break an NDIS plan. This workshop will provide an overview of NDIS reporting requirements, how to write reports to meet NDIS funding responsibilities, key terms to avoid, examples of language to use when summarising supports provided, and how to structure your report for clarity. Participants will also receive an NDIS progress report template.",
      video: '',
    },
    {
      title: "",
      ...
      about: `
      When working in the adult disability field, the needs and goals of our clients can differ widely across our client base.  It can be a bit of a minefield to perfect the balance of our clients’ own musical goals, functional outcomes that need to be reported to funding bodies, and our own creativity and skills as therapists.  But!!!  When working in the community space, we are only limited by our own creativity and the creativity of our clients. <br><br>
      This workshop will practically explore some different and creative ways to work with adults with disabilities through a music therapy program.  It will touch on group and individual programs, different interventions, and a variety of creative forms of self-expression that enable adults with disabilities to reach their own personal goals.`,
      video: '',
    },
    {
      title: "",
    ...
    },
    {
      ...
      about: `Generally, in most music therapy practices, conventional heath domain areas such as physical, cognitive, social, and speech are the therapist’s primary clinical focus. Hence, music is then used as a means for a non-musical end, and therefore goal plans, reports, as well as our identity as a discipline are guided by conventional domains rather than music domains. This presentation will introduce the idea of music as a domain area of health in which it is viewed (and heard) as a means to its own end and clinical goals and health are understood musically.`,
      video: '',
    },
    {
      title: "",
      ...
      about: `
        We are delighted that more RMTs are opening music therapy clinics around Australia! Over the last few years, we can see that this is having a positive impact on the awareness and credibility of the profession. It is important that we continue to help each other to raise the bar of our profession in <br><br>
        Private Practice. We’d like to share our key learnings and invite open discussion of various topics including Advocacy and Collaboration, Business Strategy, Adaptability, and Quality Assurance.`,
      video: '',
    },
    {
      title: "",
      ...
      As part of the AMTA’s Advocacy Plan, the Disability Working Group is revising and improving AMTA’s resources on music therapy in the NDIS. This is an ongoing process intended to provide AMTA members and other stakeholders with up-to-date information about music therapy and disability. <br><br>
      During this panel/workshop we will outline the AMTA's Advocacy Plan for further strengthening the position of the music therapy profession in the NDIS.  We will examine and seek critique on the relevance of current AMTA NDIS resources and their effectiveness in supporting members working in the Scheme.  We will also examine and seek critique on the relevance of our existing resources and information that is intended for key stakeholders other than AMTA members e.g., NDIA staff who approve music therapy in NDIS plans, NDIS participants, and other NDIS providers.  We are also eager to discuss ideas regarding the best pathways for dissemination of this information, as well as learning more about common challenges experienced by RMTs working in the sector.  A key feature of the AMTA Advocacy Plan is the engagement and involvement of all RMTs who work in the NDIS.  We believe this panel discussion/workshop is an important way for us all to come together and strengthen the position of music therapy in the NDIS now and into the future.
      `,
      video: '',
    },
    {
      ...
      `,
      about: `
      Learn clever ways to grow your business and get more clients. If you would love a simple process to create effective marketing, which delivers results in the form of new clients, then this workshop is a must. The focus of this online workshop is to assist busy therapists including business owners and contractors to not only select the right marketing channels but also generating better response rates from everything you do.<br><br>
      In this 2-hour online workshop, you will discover:<br>
       <ul><li>How to stand out as a music therapist</li><li>How to create an effective one-page marketing plan</li><li>How to select the right marketing strategies for your business (big and small)</li><li>How to get a better return from all marketing efforts.</li><li>How to build an effective online marketing machine that runs for you 24/7.</li><li>The four most important marketing funnels every business must-have.</li></ul>
      This workshop will take the confusion out of all your marketing efforts and show you how to gain more control when it comes to growing your business sustainably
      `,
      video: '',
    },
    {
      ...
      <div class="row align-items-center mt-0 mb-4 my-lg-4">
        <div class="col-7 col-lg-9">Helen Carrington has been a registered music therapist (RMT) since 2005, graduating from the University of Queensland. Her clinical work has primarily been in paediatric rehabilitation and acute care. In 2016, Helen helped to establish the permanent, senior music therapy role within the newly developed Queensland Interdisciplinary Paediatric Persistent Pain Service (QIPPPS). Helen completed the renewal of her Neurologic Music Therapy (NMT) Fellowship in paediatric persistent/chronic pain the following year.</div>
        <div class="col-5 col-lg-3"><img src="./img/pds/carrington.png" class="img-fluid mb-4 mt-4 mb-lg-0" width="200"></div>
      </div>
      <div class="row align-items-center mt-0 mb-4 my-lg-4">
        <div class="col-7 col-lg-9">Clare Kildea has worked in a range of settings in acute paediatric care, youth mental health and paediatric persistent pain. After graduating from Melbourne University in 1999, Clare worked as a music therapist in Melbourne and performed with her nationally touring band. An academic role at the University of Queensland brought her to Queensland for a 12-month position and she never left the Sunshine State. During the last 15 years in Brisbane, Clare has continued her focus on paediatric health and youth mental health in tertiary and community settings and private practice and has grown two beautiful and very musical young boys. Clare is a passionate advocate of music therapy and has been involved in the AMTA as PDS Convenor and held the inaugural National PDS Chair for 3 years.</div>
        <div class="col-5 col-lg-3"><img src="./img/pds/kildea.png" class="img-fluid mb-4 mt-4 mb-lg-0" width="200"></div>
      </div>
      `,
      about: `
