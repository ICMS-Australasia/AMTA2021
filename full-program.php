        ...
        "html": `<table cellpadding="20" cellspacing="0" border="1" width="100%" class="full-program">
            ...
            <tr valign="top">
                ...
                <td class="blue" rowspan="2">Perspectives: Responding to families’ needs: reflections on the factors that allow families to engage in Sing & Grow’s innovative alternate service delivery options <br>
                    <b>Jessica Higgins-Anderson</b></td>
                <td class="green">Paper: Music Therapy and NDIS planning in a sub-acute hospital setting: A case study about the role of the music therapist in supporting an adult patient’s transition from hospital to community following neuro-rehabilitation <br>
                    <b>Carena Khoo</b></td>
                <td class="orange" rowspan="2">Panel: Race in Music Therapy <br>
                    <b>Tanya Silveira, Asami Koike, Delphine Geia & Mai Abe</b></td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
            	...
            	<td class="red" rowspan="3">Masterclass: Connecting research to practice: The future of music therapy <br>
                    <b>Professor Katrina McFerran</b></td>
            ...
            <tr valign="top">
                ...
                <td class="purple">Leaders in Conversation: Advocacy in Music Therapy in 2020 <br>
                    <b>Dr Vicky Abad & Allison Davies</b></td>
                <td class="purple">Leaders in Conversation: Music Therapy with Children and Their Families in Hospital <br>
        ...
        <table cellpadding="20" cellspacing="0" border="1" width="100%" class="full-program">
            ...
            <tr valign="top">
                ...
                <td class="orange" rowspan="2">Panel: Mapping pathways to connection for music therapists during and after COVID-19 <br>
                    <b>Bolette Beck, Ruth Langford, Andrea Phelps, Minky van der Walt (Moderator)</b></td>
            </tr>
            <tr valign="top">
        ...
        <table cellpadding="20" cellspacing="0" border="1" width="100%" class="full-program">
            ...
            <tr valign="top">
                ...
                <td class="orange" rowspan="2">Panel: Utilisation of the Connected Music Therapy Teleintervention Approach (CoMTTA) with diverse populations during Covid19 <br>
                    <b>Roxanne McLeod, Rachel Mackay, Sydney-Rella Pihema & Allison Fuller (Moderator)</b></td>
            </tr>
            <tr valign="top">
        ...
        <table cellpadding="20" cellspacing="0" border="1" width="100%" class="full-program">
            ...
            <tr valign="top">
                ...
                <td class="orange" rowspan="2">Panel: Cancer Care in a Covid-19 Context <br>
                    <b>Kate McMahon & Penelope Sanderson (Moderator</b>)</td>
            </tr>
            <tr valign="top">
    ...
    saturday14 = {
        ...
        <table cellpadding="20" cellspacing="0" border="1" width="100%" class="full-program">
            ...
            <tr valign="top">
                ...
                <td class="purple" colspan="4">Leaders in Conversation: Indigenous and Diasporic Perspectives on Trauma
                    Emeritus Professor Judy Atkinson & Asami Koike</td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
                <td class="orange">Panel: Deliberate resilience through collective reasoning: Peer support at the management level <br>
                    <b>David Knott, Debbie Bates, Elizabeth Harman, Amy Thomas, Ann Hannan, Amy Troyano, Beth Collier & Helen Shoemark (Moderator)</b></td>
                <td class="green">Roundtable: Keeping people connected during a pandemic: Music therapy research and practice goes online <br>
                    <b>Felicity Baker, Jeanette Tamplin, Imogen Clark, Libby Flynn, Kate Teggelove, Zara Thompson, Hayley Miller & Kate McMahon</b>
                    <br> <br>
                ...
                <td class="blue">Perspectives: Changes: Discussing sound and vision in Music Therapy with a new grad and a senior music therapist <br>
                     <b>Joanne McIntyre & Netta Dortta Dor</b></td>
            </tr>
            <tr valign="top">
                <td align="center"><b>12:30pm – 1:30pm</b></td>
                <td colspan="4">Networking and lunch break</td>
            </tr>
            <tr valign="top">
                ...
                <td class="orange">Panel: Reflecting on how it all happened: Enablers and challenges for music therapy training in the time of COVID <br>
                    <b>Allison Fuller, Kate Penson & Alison Short (moderator & panellist)</b></td>
                ...
                <td class="green">Roundtable: Music therapists with lived experience of disability, neurodivergence, and chronic physical and mental health conditions: Reflecting on connections within and beyond our professional identity <br>
                    ...
                    <b>Sarah Curtain (presentation coordinator), Grace Thomspon, Allison Davies & Ben McKenzie</b>
                    <br> <br>
            ...
            <tr valign="top">
                ...
                <td class="orange">Panel: Connection within Acute Adolescent Mental Health <br>
                    <b>Jenna Murphy, Emma Fitzgerald, Catherine Garner & Ali Blundell (moderator)</b></td>
                ...
                <td class="green">Roundtable: Evolving, Reflecting, Responding: Sing&Grow’s Lessons From COVID <br>
                    ...
                    <br> <br>
                    <b>Paper 1:</b> Evolving - A reimagining of Sing&Grow in response to COVID-19
                    <br> <br>
                    <b>Paper 2:</b> Reflecting - From resilience to unforeseen challenges: pivoting and adapting to changes in delivery
                    <br> <br>
                    <b>Paper 3:</b> Responding - Looking forward</td>
    ...
    sunday15 = {
        ...
        <table cellpadding="20" cellspacing="0" border="1" width="100%" class="full-program">
            ...
            <tr valign="top">
                ...
                <td class="purple">Leaders in Conversation: Cultural Competency Across Clinical and Community Contexts
                    Sue-Anne Hunter & Neil Morris</td>
                <td class="purple">Leaders in Conversation: Music and Neuroscience: Current International Perspectives
                    Professor Dale Taylor & Professor Jörg Fachner</td>
                <td></td>
                <td></td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td class="yellow">PechaKucha Stream 1
                    <br><br>
                    ...
                    <b>Cameron Haigh</b></td>
                <td class="yellow">PechaKucha Stream 2
                    <br><br>
