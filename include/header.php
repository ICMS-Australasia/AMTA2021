      ...
      <div class="row pt-4 pb-5">
        ...
        <div class="col d-flex flex-md-column text-center text-md-right mt-5 mt-md-0">
          ...
          <div class="mt-auto mb-0 px-4 pr-md-0 pl-md-5 text-right">
            <h1 class="mb-4">VIRTUAL PDS <br> <span>Saturday 9 October 2021</span></h1>
            <h1>VIRTUAL CONFERENCE <br> <span>16 - 17 October 2021</span></h1>
          </div>
        </div>
          ...
          <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown <?php if( in_array($title, array("PDS Program – Saturday 9 October 2021", "Conference Program", "Abstract Book")) ) { echo "active"; }?>"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Program<i class="fas fa-angle-down"></i></a>
